...
const styles = StyleSheet.create({ button: { minWidth: layout.hitTarget, minHeight: layout.hitTarget, alignItems: 'center', justifyContent: 'center', borderRadius: radius.control, paddingHorizontal: space[5] }, primary: { backgroundColor: color.action.primary }, subtle: { backgroundColor: color.action.subtle }, ghost: { backgroundColor: 'transparent' }, pressed: { opacity: .72 }, disabled: { opacity: .45 }, iconButton: { width: layout.hitTarget, height: layout.hitTarget, alignItems: 'center', justifyContent: 'center', borderRadius: radius.full } });
